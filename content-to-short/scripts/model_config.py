#!/usr/bin/env python3
"""
Model configuration and cost estimation for the Content-to-Short Video Generator.
...
COSTS = {
    ...
    "deepgram_stt": 0.01,       # per STT call for word timestamps
...
if __name__ == "__main__":
    from utils import VISUAL_MODES
    print("Visual Mode Cost Comparison:\n")
    for duration, scenes in [(30, 6), (45, 9), (60, 12), (90, 18)]:
        print(f"\n{'=' * 50}")
        print(f"{duration}s video ({scenes} scenes):")
        for mode in VISUAL_MODES:
            print_cost_estimate(scenes, mode)
